    ...
    <ol class="lecture_list">
		...
		<h3>IRC is your friend</h3>
            ...
            <ol class="alert alert-error nobullets" >
                ...
                <li>4. <a class="label label-important" target="_blank"
    ...
    href="http://yacht.rit.edu/meetings/rit-foss/2013">http://yacht.rit.edu/meetings/rit-foss/2013/</a></code></li>
         ...
         <li>
           ...
           <ul class="nobullets alert alert-error">
				...
				<ul class="nobullets alert alert-success">
				<li><strong><i class="icon-book"></i> <a href="/static/books/Weber-SuccessofOpenSource-Chap3.pdf">Weber Reading</a></strong>: Was assigned W1C1, remember?</li>
                <li><strong><i class="icon-pencil"></i> <a href="/static/hw/litreview.txt">Literature Review Template:</a></strong> Weber Review Due W3C1</li>
        </ul>
</li>
