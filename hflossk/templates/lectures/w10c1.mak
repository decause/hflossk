...
<div>
    ...
    <ol class="lecture_list">
        ...
        <ol class="alert alert-success list-unstyled">
            ...
            <li>3. You will post a link to your project repository's issue tracker, like so: <code>#link http://github.com/decause/hflossk/issues</code></li>
        ...
        <li>
            ...
            <ul class="alert alert-info list-unstyled">
                <li><span class="glyphicon glyphicon-list-alt"></span> Create Tickets</li>
                <li>Examine a mature FOSS repo, such as the Python AWS Library Boto: <code><a target="_blank" href="https://github.com/boto/boto/issues">https://github.com/boto/boto/issues</a></code></li>
                <li><em>Note the usage of labels, and inclusion of tickets in a project "milestone"</em></li>
                <li>Use in-class time to begin creating milestones and tickets</li>
            </ul>
