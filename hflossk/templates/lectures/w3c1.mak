...
<div>
    ...
    <ol class="lecture_list">
        ...
        <h3>Mark-up your Readings</h3>
            ...
            <ul class="alert alert-error nobullets" >
    ...
    href="http://yacht.rit.edu/meetings/rit-foss/2013">http://yacht.rit.edu/meetings/rit-foss/2013/</a></code></li>
         ...
         <li>
           ...
           <ul class="nobullets">
                <li class="btn btn-inverse padded"><strong><i class="icon-plane
                        icon-white"></i> <a style="color:white;" href="/hw/firstflight">First
