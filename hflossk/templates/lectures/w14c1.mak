    ...
    <ol class="lecture_list">
        ...
        <li>
            ...
            <ul class="alert alert-danger list-unstyled">
                <li>Fill out Playtesting Doodle Poll:</li>
        ...
        <li>
            <h3>Class Discussion (Time Permitting)</h3>
            <ul class="alert alert-danger list-unstyled">
                <li><a target="_blank" href="/static/books/evgenymorozov-thememehustler.html">Litreview2</a></li>
            </ul>
        </li>
    </ol>
</div>
