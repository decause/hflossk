...
<div>
    ...
    <ol class="lecture_list">
        <li>
        <h3>NO CLASS MONDAY, MOVED TO TUESDAY</h3>

            <ol class="alert alert-danger list-unstyled" >
                <li><strong><span class="glyphicon glyphicon-random"></span> <a href="http://www.meetup.com/Rochester-Python-Meetup">ROC.py Meetup</a></strong>: We'll be travelling to University of Rochester to attend the ROC.py Meetup, in lieu of class on Monday.</li>
                <li><span class="glyphicon glyphicon-road"></span> Let's make a ride-board!!!</li>
            </ol>
            </li>
        <li>
    ...
    href="http://yacht.rit.edu/meetings/rit-foss/2014">http://yacht.rit.edu/meetings/rit-foss/2014/</a></code></li>
        ...
        <h3>Pop Quiz Hot Shot!</h3>
            ...
            <ol class="list-unstyled btn btn-danger" >
                <li><span class="glyphicon glyphicon-question-sign"></span><a style="color:white" target="_blank" href="/quiz/quiz1"> TOSW Quiz</a></li>
            </ol>
            </li>
